...
현재 `review` 상태인 스킨케어 초안 3건의 공식 출처와 필수 정보를 재확인했다. 모든 자료는 원문을 복사하지 않고 요약했으며, 커뮤니티 리뷰는 이번 검증에 포함하지 않았다.
...
| Round Lab 자작나무 수분 선크림 50ml | 한국 공식 상품 페이지의 50ml·22,500원, 과거 동일 제품명 공식 자료의 SPF50+ PA++++ 및 시험 기록 | `review` 유지 |
...
- Round Lab은 사용법·전성분·피부 타입·현재 판매 제품의 SPF 표시와 과거 시험 자료의 적용 여부를 추가 확인한다.
