...
- 확인한 사실: 글로벌 공식 페이지에서 100ml `US$19.80`, 55ml `US$13.50`, 30ml `US$9.50` 선택지, 현행 전성분, 사용법, 피부 타입 안내를 확인했다. 일본 공식 URL들은 재확인 시 404를 반환했으며, 과거 일본 가격은 현행 조건으로 사용하지 않는다.
- 공개 판단: `review` 유지
- 보류 이유: 일본 현행 가격·재고·전성분과 지역별 제품 동일성을 확인하지 못함. 글로벌 공식 표시를 일본 제품에 그대로 적용할 수 없고, 지역별 제품 사양을 혼합해 공개하지 않음
